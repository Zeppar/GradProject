...
class DS_Screen {
	...
	var popupButtonSizeX : int = 280;												// X size of Popup buttons ** New in LDC 4.7
	var popupButtonSizeY : int = 128;												// Y size of Popup buttons ** New in LDC 4.7
	var popupButtonSpacer : int = 32;												// Space between popup buttons ** New in LDC 4.7
...
class DUICachedInjectorsForScreen{
	...
	var iconGridTitlesEvaluated : String[] = [];
	var iconGridLabelsEvaluated : String[] = [];
	var iconGridFailedLabelsEvaluated : String[] = [];
}
